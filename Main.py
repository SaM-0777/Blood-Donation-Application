...
class Application:
    ...
    def Admin(self):
        ch = int(input("Enter 1 to see list of Donors, 2 to check Blood Request, 3 to Add a hospital, 4 to see all the Registered User for Blood Donation : "))
        ...
        if ch == 1:
            ...
            BloodBanks.BloodBanks().Add_hospital()

        elif ch == 4:
            print("All the Registered Users for Blood Donation : ")
